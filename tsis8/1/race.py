...
# Background
background = pygame.image.load("tsis8/1/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("tsis8/1/Enemy.png") #image of enemy's car
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("tsis8/1/Player.png") #image of player's car
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("tsis8/1/coin.PNG") #image of coin
...
def play_music():
    pygame.mixer.music.load("tsis8/1/background.wav")
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        ...
        pygame.mixer.Sound('tsis8/1/crash.wav').play() #sound of crash
